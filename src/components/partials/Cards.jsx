...
function Cards({ data, title }) {
  return (
    <div className="flex flex-wrap justify-center w-full h-full px-[5%] bg-[#1f1e24] mt-8">
      {data.map((c, i) => (
        <Link
        ...
        >
          <img
            ...
            alt=""
          />
          <h1 className=" text-2xl text-zinc-200 mt-2 font-semibold text-center overflow-hidden text-ellipsis line-clamp-2">
